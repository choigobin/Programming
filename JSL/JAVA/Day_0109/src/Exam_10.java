...
public class Exam_10 {
	public static void main(String[] args) {
		int score[][] = { { 1, 90, 78, 79, 0, 1 }, { 5, 95, 80, 70, 0, 1 }, { 2, 79, 88, 77, 0, 1 },
				{ 4, 75, 88, 77, 0, 1 }, { 3, 95, 88, 75, 0, 1 } };
		...
		for (int x = 0; x < score.length; x++) {
			...
			average[x] = (int) ((score[x][4] / 3.) * 100 + 0.5) / 100.;
		}
		// 석차 계산
		for (int x = 0; x < score.length; x++) {
