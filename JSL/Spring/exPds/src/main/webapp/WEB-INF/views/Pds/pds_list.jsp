					...
					<tr>
						<td colspan="7" align="center" valign="center" height="20"><font
							size="4" face="돋움" color="blue"> <img
								src="/img/bullet-01.gif"> <b>참 좋은 자료들</b></font></td>
					</tr>
					<tr>
...
<c:forEach var="pds" items="${list}">
					<tr onMouseOver="style.backgroundColor='#D1EEEE'"
						...
						<td align="left" height="20">&nbsp;<a href="pdsHits?idx=${pds.idx}&page=${page}"><font face="돋움" size="2">${pds.subject}
							</font></a></td>
						<td align="center" height="20"><a href="/resources/upload/${pds.filename}"><font face="돋움" size="2">${pds.filename}</a></td>
					...
					<tr>
						<td colspan="5" align="center"><font face="돋움" size="2"
							color="#000000">${listPage}</td>
					</tr>
					<tr>
						<td colspan="7" align="right">
						<a href="pds_write?page=${page}"><img src="/img/write.gif"
							alt="자료등록" align="middle" border="0"></a></a> &nbsp;</td>
					</tr>
					...
					<table border="0" cellspacing="0" width="100%">
						<tr>
							<td>
									...
									<font color="#004080" size="4" face="Courier New">
									...
									&nbsp;&nbsp;
									<input type="text" name="key" size="20" value="${pageVO.key}">
									&nbsp;&nbsp;
									<a href="javascript:p_search()"><img src="/img/search2.gif" align="middle"></a>
