...
function send() {
	...
	if(!/\d{5,16}/.exec(form_name.userid.value)){
	...
	if(!/\d{6,12}/.exec(form_name.passwd.value)){
            ...
            <table cellpadding=0 cellspacing=0 border=0 width=100%>
              ...
              <tr bgcolor=#ffffff>
                <td colspan=3 align=center>
                  ...
                  <button type="reset"><img src="./img/u_bt05.gif" border=0 hspace=10 vspace=3 name=img4></button>
                </td>
              </tr>
            </table> 
          </td>
