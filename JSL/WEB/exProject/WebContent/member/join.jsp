		...
		<div class="join_write col_989">
            ...
            <table class="table_write02" summary="회원가입을 위한 이름, 아이디, 비밀번호, 비밀번호확인, 소속, 유선전화번호, 휴대전화번호, 이메일, 주소, 본인확인질문, 본인확인답, 주활용사이트, 알림여부 정보 입력">
                ...
                <tbody id="joinDataBody">
                    <tr>
                        <th><label for="name">이름<span style="color: red;">*</span></label></th>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="userid" id="mbrId"  class="w300" >
                        </td>
                    </tr>
                    <tr>
                        <th><label for="pw">비밀번호<span style="color: red;">*</span></label></th>
                        <td>
					...
					<tr>
                        <th><label for="phone">전화번호<span style="color: red;">*</span></label></th>
                        <td>
                            <input type="text" name="phone1" id="phone1" style="width: 60px;" maxlength="3" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"> - 
                            <input type="text" name="phone2" id="phone2" style="width: 80px;" maxlength="4" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"> - 
                            <input type="text" name="phone3" id="phone3" style="width: 80px;" maxlength="4" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');">
                        </td>
                    </tr>
                    <tr>
                        <th><label for="email">이메일<span style="color: red;">*</span></label></th>
                        <td>
