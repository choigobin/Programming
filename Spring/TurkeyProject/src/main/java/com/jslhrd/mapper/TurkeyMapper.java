...
public interface TurkeyMapper {
	...
	//Notice - 게시물 조회수 증가
	public void noticeReadcnt(int idx);
	...
	public List<SubListVO> studentScoreSearchSemester(StudentVO vo);

	public List<SubListVO> studentScoreSearchYear(StudentVO vo);

	public List<SubListVO> studentScoreSearchNo(StudentVO vo);
	...
	public List<AttVO> studentAttSearchSemester(StudentVO vo);

	public List<AttVO> studentAttSearchYear(StudentVO vo);

	public List<AttVO> studentAttSearchNo(StudentVO vo);
