...
<c:forEach var="guest" items="${list}">
	   <tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
        ...
        <font face="돋움" size="2" color="#000000">
		       <a href="guestHits?idx=${guest.idx}">${guest.subject}</a></td>
						...
						<tr>
							<td>
								<select name="search">
									...
									<option value="contents" ${contents}>글내용</option>
								</select>
							</td>
							<td> <input type="text" size=20 name="key" value="${pageVO.key}"></td>
							<td> <a href="javascript:g_search()"><img src="/img/search2.gif" border="0"></a></td>
						</tr>
					</form>
				</table>
			</td>
