	...
	<table border="0" width="800">
		<tr>
			...
			<td width="80%" valign="top">&nbsp;<br>
						...
						<td class="content">
							<p align="right">
								<font size="2" face="돋움"> <a class="list"
									href="mailto:ein1027@nate.com">${board.name }</a> / <font size="2"
									face="돋움">${board.regdate.substring(0,10) } / ${board.readcnt }번 읽음</font>
									<p>${board.contents }
									<p>
				...
				<p align="center">
					<font size="2"> <!-- 새글쓰기 --> <a href="board_write?page=${page }"> <img
							src="/img/write.jpg" border="0"></a>&nbsp;&nbsp; <!-- 답글쓰기 -->
						<a href=""> <img src="/img/reply.gif" border="0"></a>&nbsp;&nbsp;
						<!-- 수정하기 --> <a href="board_modify?idx=${board.idx }&page=${page}"> <img src="/img/edit.gif" border="0"></a>&nbsp;&nbsp;
						<!-- 삭제하기 --> <a href="board_delete?idx=${board.idx }&page=${page}"><img src="/img/del.gif" border="0"></a>&nbsp;&nbsp;
						<!-- 목록보기 --> <a href="board_list?page=${page }"><img src="/img/list-2.gif" border="0"></a>&nbsp;&nbsp;
