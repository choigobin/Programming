						...
						<tr onMouseOver="style.backgroundColor='#D1EEEE'"
							...
							<td align="left" height="20">&nbsp; <font face="돋움" size="2"
								color="#000000"> <a class="list"
									href="boardHits?idx=${board.idx }&page=${page }">${board.subject }</a></td>
						...
						<table width="600">
							<tr>
										...
										<form name="board" method="post" action="board_list">
											...
											<tr>
												<td><select name="search">
														<option value="name"
															<c:if test="${pageVO.search =='name'}">selected</c:if>>작성자</option>
												...
												<td><a href="javascript:b_search()"><img
								...
								<td width="25%" align="right"><a
									href="board_write?page=${page }"><img src="/img/write.gif"
										border="0"></a></td>
							</tr>
						</table>
</body>
