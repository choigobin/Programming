...
function check() {
	...
	if(!board.subject.value) {
		alert("제목을 입력하세요");
		board.subject.select();
		return ;
	}
	// 내용 입력 검사
	if(!board.contents.value) {
		alert("내용을 입력하세요");
		board.contents.select();
		return ;
	}
	board.submit();
}
	...
	<tr>
		<td align="center" height="100%" valign=middle><br>
			<table width="30%" border="1" cellspacing="0" cellpadding="3" bgcolor="#FFCC66" bordercolor="#FFFFFF" bordercolorlight="#000000">
				<tr> 
					<td height=40 align="center" style="font-size: 15px;"><b>자유 게시판</b>
					</b></td>
				</tr>
			</table><br>
			<table width="60%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
					<form name="board" method="post" action="BoardServlet?cmd=board_write_pro">
					...
					<table width="100%" border="0" cellpadding="6" cellspacing="1" bgcolor="DDDDDD">
							<tr>
								...
								<td bgcolor="ffffff"><input name="name" type="text" value=""  style="width:450; height:18; padding:2; border:1 solid slategray" size="120"></td>
							</tr>
							<tr>
								<td width="20%" align="center" bgcolor="EcECEC"><strong>이메일</strong></td>
								<td bgcolor="ffffff"><input name="email" type="text" value=""  style="width:450; height:18; padding:2; border:1 solid slategray" size="120"></td>
							</tr>
							<tr>
			...
			<table width="60%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align=center><a href="javascript:check()"><b> [등록]</b></a>&nbsp; 
