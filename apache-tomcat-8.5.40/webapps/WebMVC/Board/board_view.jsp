...
function board_delete() {
	   var urlString;
	    urlString = "BoardServlet?cmd=board_delete&idx=${vo.idx}&page=${page}" ;
	    window.open(urlString, "del_list"," resizable=yes,x=150,y=150,width=300,height=170");
	 }
	...
	<tr>
		<td align="center" height="100%" valign=middle><br>
			...
			<table width="60%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align=center>
						<a href="BoardServlet?cmd=board_edit&idx=${vo.idx}&page=${page}"><b>[수정]</b></a>&nbsp; 
						<a  href="javascript:board_delete();"><b>[삭제]</b></a>&nbsp; 
						<a href="BoardServlet?cmd=board_list&page=${page}"><b>[목록]</b></a>
					</td>
				</tr>
			</table>
</body>
