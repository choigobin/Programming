	...
	<tr>
		<td align="center" height="100%" valign=middle><br>
			<table width="30%" border="1" cellspacing="0" cellpadding="3" bgcolor="#FFCC66" bordercolor="#FFFFFF" bordercolorlight="#000000">
				<tr> 
					<td height=40 align="center" style="font-size: 15px;"><b>자유 게시판 </b></a>
						</b></td>
				</tr>
			</table><br>
                  ...
                  <td>
                    <table width="100%" border="0" cellpadding="6" cellspacing="1" bgcolor="DDDDDD">
                      <tr bgcolor="EcECEC">
                        ...
                        <td width="20%" align="center"><strong>작성자</strong></td>
                      ...
                      <tr>
                        ...
                        <td bgcolor="#FFFFFF"><a href="BoardServlet?cmd=board_view&idx=${list.idx}&page=${page}" class="unnamed1">${list.subject}</a></td>
                        ...
                        <td colspan="10" align="center" bgcolor="#FFFFFF">
                          ...
                          <table width="610" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <a href="BoardServlet?cmd=board_write&page=${page}"><b>[글쓰기]</b></a></td>
                            </tr>
                       		</tr>		
                      	   </table>
                      	   </form>
