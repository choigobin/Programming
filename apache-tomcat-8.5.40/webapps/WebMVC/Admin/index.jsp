...
<form name="frm" method="post" action="JoinServlet?cmd=login_ok">
  <tr>
                      ...
                      <td width="308" align="center" background="img/admin_img07.gif"> 
                        ...
                        <table width="275" height="63" border="0" cellpadding="0" cellspacing="0">
                          <tr> 
                            ...
                            <td width="61" rowspan="3"><input type='image' src="img/admin_img12.gif" alt="connect" value="submit" width="61" height="63" border="0" onfocus=blur()></td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td><img src="img/admin_img11.gif" alt="비밀번호" width="64" height="19" align="absmiddle"> 
                              <input name="adpass" type="password" tabindex="2" style="width:140px;"></td>
                          </tr>
                        </table>
                        <!--// 도메인, 관리계정, 비밀번호 -->
                      </td>
