	...
	<tr>
		<td align="center" height="100%" valign=middle><br>
			...
			<table width="60%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
					<form name="pds" method="post" enctype="multipart/form-data" action="PdsServlet?cmd=pds_write_pro">
					...
					<table width="100%" border="0" cellpadding="6" cellspacing="1" bgcolor="DDDDDD">
							...
							<tr>
								...
								<td bgcolor="ffffff"><input name="eamil" type="text" value=""  style="width:450; height:18; padding:2; border:1 solid slategray" size="120"></td>
							</tr>
							<tr>
