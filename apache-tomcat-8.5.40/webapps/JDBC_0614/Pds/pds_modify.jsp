...
<tr>
  ...
  <b> 자료실</b></font><font size="2"> - 자료 수정하기</font><p>
  ...
  <img src="./img/bullet-02.gif"><font size="2" face="돋움">는 필수 입력 사항입니다.</font><p>
     <form name="pds" method="post" action="pds_edit.do" enctype="multipart/form-data">
		<input type="hidden" name="num" value="${pds.num}">
