...
<c:forEach var="pds" items="${list }">	 
      <tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
		...
		<td align="left" height="20">&nbsp;<a href="pds_view.do?num=${pds.num}"><font face="돋움" size="2">${pds.subject}</font></a></td>
		...
		<td align="left" height="20"><font face="돋움" size="2">${pds.indate.substring(0,10)}</font></td>
...
<c:if test="${list.size()==0 }" >      
   ...
   <tr>
      <td colspan="7" align="right">
				<a href="pds_write.do"><img src="./img/write.gif" alt="자료등록" align="middle" border="0"></a>
      &nbsp;
	  </td>
   </tr>
