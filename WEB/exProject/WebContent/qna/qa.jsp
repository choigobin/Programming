	  ...
	  <div class="bord_list">
		<table class="bord_table" summary="이표는 번호,제목,답변상태, 작성자, 작성일, 조회수로 구성되어 있습니다">
			...
			<tbody>
				<tr>
					<td>8</td>
					<td class="title"><a href="/qna/qa_view.jsp">입학절차에 대하여 알고 싶어요</a></td>
				...
				<tr>
					<td>7</td>
					<td class="title"><a href="/qna/qa_view.jsp">무엇이 궁금한가요?</a></td>
				...
				<tr>
					<td>6</td>
					<td class="title"><a href="/qna/qa_view.jsp">궁굼한내용제목입니다</a></td>
					<td><span class="waiting">답변대기</span></td>
					<td>관리자</td>
					<td>18-10-16</td>
					<td>187</td>
		...
		<div class="paging">
			...
			<a href="/qna/qa_write.jsp" class="btn_write">글쓰기</a>
		</div>
	  </div>
	</div>
	<!-- end contents -->
