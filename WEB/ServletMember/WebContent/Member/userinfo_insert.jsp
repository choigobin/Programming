...
<script type="text/javascript">
	function id_check(){
		window.open("/ServletMember/Member/id_check.jsp","id_check form","width=340 height=240");
	}
	function insertPro() {
...
<tr>
  ...
  <td width="80%" valign="top">&nbsp;<img src="/ServletMember/Member/img/title1.gif" ><br>    
	<form name=member method=post action="/ServletMember/Insert">
	<table border=0 cellpadding=0 cellspacing=0 border=0 width=730 valign=top>
		<tr><td align=center><br>                            
				...
				<tr>
					<td bgcolor="#7AAAD5">            
						<table cellpadding=0 cellspacing=0 border=0 width=100%>
							<tr bgcolor=#7AAAD5>
								<td align=left BORDER="0" HSPACE="0" VSPACE="0"><img src="/ServletMember/Member/img/u_b02.gif"></td>
								...
								<td align=right BORDER="0" HSPACE="0" VSPACE="0"><img src="/ServletMember/Member/img/u_b03.gif"></td>
							</tr>
						</table>
							...
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<table cellspacing=0 cellpadding=0>
										<tr>
											<td align=absmiddle>
												<input type=text name=userid size=12 maxlength=16 value="" readonly style="background:gray; color:white; width:120" >
											</td>
											<td>
                  			<a href="javascript:id_check()"><img src="/ServletMember/Member/img/u_bt01.gif" hspace=2 border=0 name=img1  align=absmiddle></a>
            ...
            <table cellpadding=0 cellspacing=0 border=0 width=100%>
              <tr bgcolor=#7AAAD5>
                <td valign=bottom>
                  <img src="/ServletMember/Member/img/u_b04.gif" align=left hspace=0 vspace=0 border=0>
                </td>
                <td align=center></td>
                <td valign=bottom>
                  <img src="/ServletMember/Member/img/u_b05.gif" align=right hspace=0 vspace=0 border=0>
                </td>
              </tr>
              <tr bgcolor=#ffffff>
                <td colspan=3 align=center>
                  <a href="#" onclick="insertPro()"><img src="/ServletMember/Member/img/u_bt06.gif" vspace=3 border=0 name=img3></a>
                  <img src="/ServletMember/Member/img/u_bt05.gif" border=0 hspace=10 vspace=3 name=img4>
                </td>
              </tr>
            </table> 
          </td>
